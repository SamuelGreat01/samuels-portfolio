const ARTICLE_DATA = [
  {
    title: 'Vue.js Quickstart Tutorial by @samuel_great',
    description:
      'Vue is a progressive JavaScript framework that focuses on building user interf...',
    link:
      'https://dev.to/samuel_great/vuejs-2-quickstart-tutorial-by-codewonders-2972',
    imageUrl:
  ...
  {
    title: 'Best websites a programmer should visit in 2018 @samuel_great',
  ...
  },
  {
    ...
    link:
      'https://dev.to/samuel_great/what-are-these-things-called-generator-functions-58nn',
    imageUrl: 'https://i.ibb.co/wc3m88r/cloud.png',
    type: ['article'],
  },
  {
    title: 'Let’s Create a Blog with React & Node @samuel_great',
    description: '',
    link:
      'https://medium.com/@samuel_great/lets-create-a-blog-with-react-node-code-wonders-33978ed45e59',

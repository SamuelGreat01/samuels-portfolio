    ...
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <motion.h1
              data-text="I'm Samuel Great"
              className="intro__text"
              {...getTransitions(0.1)}
            >
              <mark className="mark">I&apos;m Samuel Great</mark>
            </motion.h1>
            <motion.p {...getTransitions(0.3)}>
              ...
              that solve real problems with accessible, user-centered solutions.{' '}
            </motion.p>
            <motion.p {...getTransitions(0.5)}>
              I specialize in product design, UI/UX, and Figma.  When I'm not
              studying or working on clinical placements, you can find me exploring{' '}
              <Link
                href="/articles"
              ...
              about healthcare tech, diving into{' '}
              <Link href="/articles" aria-label="Check out my Lens">
                design systems
              </Link>{' '}
              or just enjoying some good music. Feel free to{' '}
              <Link href="/contact" aria-label="Go to Contact Page">
                get in touch
              </Link>{' '}
              if you want to chat about product design, healthcare, or anything else!
            </motion.p>
          </article>
